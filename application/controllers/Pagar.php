...
class Pagar extends CI_Controller{
  ...
  public function pg_debito()
  {
    ...
    if ($this->form_validation->run()) {
      ...
      $pagarBoleto['token'] = $config->token;
      $pagarBoleto['paymentMode'] = 'default';
      $pagarBoleto['paymentMethod'] = 'eft';
      $pagarBoleto['bankName'] = $this->input->post('nome_banco');
      $pagarBoleto['currency'] = 'BRL';
      $pagarBoleto['extraAmount'] = '';
  ...
  public function pg_cartao()
  {
    ...
    if ($this->form_validation->run()) {
      ...
      $pagarBoleto['token'] = $config->token;
      $pagarBoleto['paymentMode'] = 'default';
      $pagarBoleto['paymentMethod'] = 'creditCard';
      $pagarBoleto['currency'] = 'BRL';
      $pagarBoleto['extraAmount'] = '';
      ...
      //TOKEN DO CARTAO DE CREDITO
      $pagarBoleto['creditCardToken'] = $this->input->post('token_pagamento');

      $pagarBoleto['creditCardHolderName'] = remove_acentos($nomeComprador);
      $pagarBoleto['creditCardHolderCPF'] = limparString($cpfComprador);
      $pagarBoleto['creditCardHolderAreaCode'] = limparString($telefoneComprador[0]);
      $pagarBoleto['creditCardHolderPhone'] = limparString($telefoneComprador[1]);
      $pagarBoleto['billingAddressStreet'] = remove_acentos($enderecoComprador);
      $pagarBoleto['billingAddressNumber'] = $numeroComprador;
      $pagarBoleto['billingAddressDistrict'] = remove_acentos($bairroComprador);
      $pagarBoleto['billingAddressPostalCode'] = limparString($cepComprador);
      $pagarBoleto['billingAddressCity'] = remove_acentos($cidadeComprador);
      $pagarBoleto['billingAddressState'] = $estadoComprador;
